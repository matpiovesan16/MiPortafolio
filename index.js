...
function menuAbrirPortafolio(){
    ...
    navBar.setAttribute('class','text-slate-200 text-xl animate__animated animate__fadeInDown max-sm:flex max-sm:h-full max-sm:flex-col max-sm:justify-center relative top-[10%]');
