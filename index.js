...
function menuAbrirPortafolio(){
    ...
    cajaMenu.setAttribute('class', 'flex justify-between w-full p-9 max-sm:fixed max-sm:top-0 max-sm:bg-slate-900 max-sm:z-10 max-sm:h-2/4');
    navBar.setAttribute('class','text-slate-200 text-xl animate__animated animate__fadeInDown max-sm:flex max-sm:h-[200px] max-sm:flex-col max-sm:items-center max-sm:justify-center relative top-[15%] left-[-5%]');
